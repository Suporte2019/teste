...
class User extends Authenticatable
{
 use Notifiable;
    ...
    protected $fillable = [
    'name', 'email', 'password','tipo','empresa','status',
    ];
 ...
 //tem a role atribuída a ele, se sim, retorna true//
    ...
    public function registra_log_acesso_login()
    {
    ...
    public function registra_log_acesso_logout()
    {
     
    //Reconecta ao banco principal para gravar o LOGOUT;
    $db_adm = 'adm_empresas';
    //Configura conexão;
    config()->set('database.connections.empresa.database', $db_adm);
    //Reconecta DB_CONNECTION=empresa;
