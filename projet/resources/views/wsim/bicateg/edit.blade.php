      ...
      <form class="form-horizontal" action="{{ route ('categoria.update',$categoria->id )}}" method="post">
       ...
       <input type="hidden" name="_method" value="put">
           ...
           <!--div class="form-group">
            ...
            <div class="col-sm-1">
             <input class="form-control" name="id" type="text" disabled value="{{$categoria->id}}"> 
            </div>
          </div-->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-1">
             <input class="form-control" name="id_categ" type="text" readonly value="{{$categoria->id_categ}}">
           </div>
         </div>
