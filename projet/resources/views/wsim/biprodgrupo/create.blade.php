...
@section('title', 'Adicionar - Grupo de Produto')
				...
				<div class="col-md-11">
					<div class="panel panel-default">
						...
						<!--div class="panel-body"-->
							...
							<form class="form-horizontal" action="{{ route ('produtogrupo.store')}}" method="post">
								{{ csrf_field() }}
								...
								<div class="form-group">
									...
									<div class="col-sm-1">
										<input class="form-control" name="id_grupo" type="text" >
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="panel-footer">  
										...
										<a class="btn btn-default btn-sm" href="{{ route('produtogrupo.create')}}">
