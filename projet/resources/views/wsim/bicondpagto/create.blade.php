				...
				<div class="col-md-11">
					<div class="panel panel-default">
						...
						<!--div class="panel-body"-->
							...
							<form class="form-horizontal" action="{{ route ('condpagto.store')}}" method="post">
								{{ csrf_field() }}
								...
								<div class="form-group {{ $errors->has('id_cond_pag') ? 'has-error' : '' }}">
									<label class="col-sm-2 control-label" for="id_cond_pag">Código:</label>
									<div class="col-sm-1">
										<input class="form-control" name="id_cond_pag" type="text" value="{{old('id_cond_pag')}}">
										@if ($errors->has('id_cond_pag'))
									<span class="help-block">
										<strong>{{ $errors->first('id_cond_pag') }}</strong>
									</span>
									@endif
								...
								<div class="form-group">
									...
									<div class="col-sm-2">     
										<input class="form-control" type="number" name="parcelas" value="{{old('parcelas')}}" placeholder="Parcelas">
									</div> 
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">     
										<input class="form-control" type="text" name="prazo_medio" value="{{old('prazo_medio')}}"placeholder="Prazo Médio">
									</div> 
								</div>
