...
@section('title', 'Listar - Regionais')
     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
       <div class="col-md-1">
        ...
        <a class="btn btn-default btn-sm" href="{{ route('regional.create')}}"><i class="fa fa-plus-square"style="color:green"></i> Adicionar</a>
       ...
       <div class="col-md-4">
        <form action="{{ route ('regional.index')}}" method="get">
         ...
         <div class="input-group input-group-sm">
          <input type="text" name="criterio" class="form-control" placeholder="buscar nome da regional...">
      ...
      <table id="#teste" class="table table-bordered table-striped" style="width:100%">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>{{$regional->nome}}</td>
         <td>{{$regional->ativo}}</td>
         <td>{{ date('d/m/Y H:m:s', strtotime($regional->dt_alt))}}</td>

         <td style="text-align: right;">

         <form class="delete" action="{{ route('regional.destroy', $regional->id) }}" method="POST">
           
           <a href="{{route('regional.edit',$regional->id)}}" class="btn btn-link btn-xs">
