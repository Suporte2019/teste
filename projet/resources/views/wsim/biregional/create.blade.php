...
@section('title', 'Adicionar - Regional')
			...
			<div class="col-md-11">
				<div class="panel panel-default">
					...
					<ol class="breadcrumb panel-heading">
						...
						<li><a href="{{route('regional.index')}}">Regionais</a></li>
						<li class="active">Adicionar</li>
					</ol>

					<!--div class="panel-body"-->

						<form class="form-horizontal" action="{{ route ('regional.store')}}" method="post">
							{{ csrf_field() }}
							...
							<div class="form-group">
								...
								<div class="col-sm-1">
									<input class="form-control" name="id_regional" type="text" >
								</div>
							</div>
								...
								<div class="row">
										<div class="col-md-12">
											<div class="panel-footer">  
												...
												<a class="btn btn-default btn-sm" href="{{ route('regional.create')}}">
