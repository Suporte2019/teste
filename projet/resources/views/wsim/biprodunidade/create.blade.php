<!--
 * wsim/biprodunidade/create.blade
 *
 * @version    1.0
 * @package    control
 * @subpackage BI
...
@section('title', 'Adicionar - Unidade do Produto')
				...
				<div class="col-md-11">
					<div class="panel panel-default">
						...
						<!--div class="panel-body"-->
							...
							<form class="form-horizontal" action="{{ route ('produtounidade.store')}}" method="post">
								{{ csrf_field() }}
								...
								<div class="form-group ">
									<label class="col-sm-2 control-label" for="id_unid">Código:</label>
									<div class="col-sm-1">
										<input class="form-control" name="id_unid" type="text" >
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="panel-footer">  
										...
										<a class="btn btn-default btn-sm" href="{{ route('produtounidade.create')}}">
